...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    ...
    // The recovery link's session is parsed from the URL on load — wait for it
    // (or an existing session) before showing the "set new password" form.
      ...
      <div className="w-full max-w-md">
        ...
        {done ? (
          <div className="bg-surface-bright border border-outline-variant rounded-lg p-6 text-center">
            ...
            <p className="text-body-md text-on-surface-variant">Taking you to your dashboard…</p>
          </div>
        ) : !ready ? (
          <div className="bg-surface-bright border border-outline-variant rounded-lg p-6 text-center">
            ...
            <Link href="/forgot-password" className="inline-block mt-4 text-primary hover:underline text-body-sm">
              Request a new link
            </Link>
          </div>
        ) : (
          <>
            ...
            <p className="text-body-md text-on-surface-variant mb-8">Choose a new password for your account.</p>
