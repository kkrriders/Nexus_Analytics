        ...
        {sent ? (
          <div className="bg-surface-bright border border-outline-variant rounded-lg p-6 text-center">
            ...
            <p className="text-body-md text-on-surface-variant">
              If an administrator account exists for <span className="font-medium text-on-surface">{email}</span>, we&apos;ve sent a link to reset your password.
            </p>
          ...
          <>
            ...
            <p className="text-body-md text-on-surface-variant mb-8">
              Enter the email associated with your admin account and we&apos;ll send a link to reset your password.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              <div>
                <label htmlFor="email" className="block text-label-md text-on-surface-variant mb-1.5">Work email</label>
